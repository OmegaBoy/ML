...
#%% Cargo los datos
df_train= pd.read_csv('NPL/train.csv')
df_test=pd.read_csv('NPL/test.csv')
...
# %% python -m nltk.downloader <nltk package>
...
# %%  vectorization or in the NLP world, word embedding. Bag-of-Words(BoW) and Word Embedding
...
class MeanEmbeddingVectorizer(object):
    def __init__(self, word2vec):
        ...
        self.dim = len(repr(next(iter(word2vec.values()))))
    def fit(self, X, y):
        return self
